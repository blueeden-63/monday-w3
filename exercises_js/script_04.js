...
// Filtrer dans cette liste les entrepreneurs qui sont nés dans les années 70s
let seventies = entrepreneurs.filter(entrepreneurs =>entrepreneurs.year >= 1970 && entrepreneurs.year <1980);
